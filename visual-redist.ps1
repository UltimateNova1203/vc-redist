...
if ($OSArch -eq "ARM64") {
	...
	Invoke-WebRequest -Uri "https://raw.githubusercontent.com/UltimateNova1203/visual-redist/master/vc2012-arm64.exe" -OutFile C:\visual-redist\vc2012-arm64.exe
	Write-Output "Installing Visual C++ 2012 ARM64 Redistributable..."
	Start-Process C:\visual-redist\vc2012-arm64.exe -ArgumentList "/install /quiet /norestart" -wait
	Write-Output "Visual C++ 2012 ARM64 Redistributable Installed!"

	#VC2013-x64
	Write-Output "Downloading Visual C++ 2013 ARM64 Redistributable..."
	Invoke-WebRequest -Uri "https://raw.githubusercontent.com/UltimateNova1203/visual-redist/master/vc2013-arm64.exe" -OutFile C:\visual-redist\vc2013-arm64.exe
	Write-Output "Installing Visual C++ 2013 ARM64 Redistributable..."
	Start-Process C:\visual-redist\vc2013-arm64.exe -ArgumentList "/install /quiet /norestart" -wait
	Write-Output "Visual C++ 2013 ARM64 Redistributable Installed!"

	#VC2019-x64
	Write-Output "Downloading Visual C++ 2019 ARM64 Redistributable..."
	Invoke-WebRequest -Uri "https://raw.githubusercontent.com/UltimateNova1203/visual-redist/master/vc2019-arm64.exe" -OutFile C:\visual-redist\vc2019-arm64.exe
	Write-Output "Installing Visual C++ 2019 ARM64 Redistributable..."
	Start-Process C:\visual-redist\vc2019-arm64.exe -ArgumentList "/install /quiet /norestart" -wait
...
if ($OSArch -eq "IA64") {
	...
	Invoke-WebRequest -Uri "https://raw.githubusercontent.com/UltimateNova1203/visual-redist/master/vc2008-ia64.exe" -OutFile C:\visual-redist\vc2008-ia64.exe
	...
	Invoke-WebRequest -Uri "https://raw.githubusercontent.com/UltimateNova1203/visual-redist/master/vc2010-ia64.exe" -OutFile C:\visual-redist\vc2010-ia64.exe
	Write-Output "Installing Visual C++ 2010 IA64 Redistributable..."
	Start-Process C:\visual-redist\vc2010-ia64.exe -ArgumentList "/q /norestart" -Wait
